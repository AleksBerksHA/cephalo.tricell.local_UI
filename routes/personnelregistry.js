...
router.get('/', (request, response) =>
{
    ...
    async function sqlQuery()
    {
        ...
        {
            htmloutput += "<td width=\"350\" align=\"right\"><a href=\""+ config.webaddress+"/api/newemployee\" style=\"color:#336699;\">Add new employee</a></td>";
        }
        htmloutput += "</tr></table>"+
        ...
        for(i=0; i<count; i++)
        {
		    ...
		    "<td class=\"infodark\" width=\"210\">&nbsp;<a href=\""+ config.webaddress+"/api/personnelregistry/"+str_employeeCode+"\">"+str_name+"</a></td>" +
            ...
            if(request.session.loggedin)
            {
                htmloutput += "<td class=\"infolight\" width=\"116\"><a href=\""+ config.webaddress+"/api/editemployee/"+id+"\" style=\"color:#336699;\">E</a></td>";
                htmloutput += "<td class=\"infolight\" width=\"116\"><a href=\""+ config.webaddress+"/api/deleteemployee/"+id+"\" style=\"color:#336699;\">D</a></td>";
            }
		    htmloutput += "</tr>" +
            "";
        }
